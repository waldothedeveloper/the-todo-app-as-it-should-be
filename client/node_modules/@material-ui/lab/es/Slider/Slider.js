...
export const styles = theme => {
  ...
  const thumbCommonTransitions = theme.transitions.create(['width', 'height', 'left', 'right', 'bottom', 'box-shadow'], commonTransitionsOptions); // no transition on the position
